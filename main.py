...
pytesseract.pytesseract.tesseract_cmd = r'C:\Users\madia\AppData\Local\Programs\Tesseract-OCR\tesseract.exe'
...
def process_image(img_path):
    try:
        ...
        carplate_haar_cascade = cv2.CascadeClassifier('C:\#Сoding\Python\AI\haar_cascades\haar_cascades\haarcascade_russian_plate_number.xml')
